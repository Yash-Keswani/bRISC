...
_PIPELINE_LINE_USAGE = _PIPELINE.nested_types_by_name['line_usage']
...
_TRACER = DESCRIPTOR.message_types_by_name['tracer']
_TRACER_TRACE = _TRACER.nested_types_by_name['trace']
...
pipeline = _reflection.GeneratedProtocolMessageType('pipeline', (_message.Message,), {
	...
	'line_usage': _reflection.GeneratedProtocolMessageType('line_usage', (_message.Message,), {
		'DESCRIPTOR': _PIPELINE_LINE_USAGE,
		'__module__': 'template_pb2'
		# @@protoc_insertion_point(class_scope:pipeline.line_usage)
	})
	,
...
_sym_db.RegisterMessage(pipeline.line_usage)
...
tracer = _reflection.GeneratedProtocolMessageType('tracer', (_message.Message,), {
	
	'trace': _reflection.GeneratedProtocolMessageType('trace', (_message.Message,), {
		'DESCRIPTOR': _TRACER_TRACE,
		'__module__': 'template_pb2'
	...
	'DESCRIPTOR': _TRACER,
	'__module__': 'template_pb2'
	# @@protoc_insertion_point(class_scope:tracer)
})
_sym_db.RegisterMessage(tracer)
_sym_db.RegisterMessage(tracer.trace)
...
if _descriptor._USE_C_DESCRIPTORS == False:
	...
	_PIPELINE._serialized_start = 457
	_PIPELINE._serialized_end = 535
	_PIPELINE_LINE_USAGE._serialized_start = 506
	_PIPELINE_LINE_USAGE._serialized_end = 535
	_EXECUTOR._serialized_start = 538
	_EXECUTOR._serialized_end = 688
	_MEMORY._serialized_start = 690
	_MEMORY._serialized_end = 745
	_REGISTRY._serialized_start = 748
	_REGISTRY._serialized_end = 910
	_REGISTRY_SREGSENTRY._serialized_start = 866
	_REGISTRY_SREGSENTRY._serialized_end = 910
	_TRACER._serialized_start = 912
	_TRACER._serialized_end = 996
	_TRACER_TRACE._serialized_start = 953
	_TRACER_TRACE._serialized_end = 996
